...
const data = [
  { name: 'Completed', value: 2560 },
  { name: 'Pending', value: 2150 },
  { name: 'On-Hold', value: 2780 },
  { name: 'Advance', value: 2000 },
];
...
export default function TopTrafficSource({
  ...
  return (
    <WidgetCard title={'Payment Status Chart'} rounded="lg" className={className}>
