...
import useAddPurchase from "@/api/hooks/transaction/purchase/useAddPurchase";
...
const CreatePurchase = () => {
  ...
  const totalProductInitialValue = {
    quantity: 0,
    sub_total: 0,
  ...
  useEffect(() => {
    if (productWatch && productWatch.length > 0) {
      ...
      setSelectedProducts([]);
      setTotalProduct(totalProductInitialValue);
    }
  ...
  const [totalProduct, setTotalProduct] = useState(totalProductInitialValue);
