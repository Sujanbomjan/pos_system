            ...
            return (
              <Fragment key={item.name + "-" + index}>
                {item?.href ? (
                          ...
                          return (
                            <>
                              {dropdownItem.dropdownItems ? (
                                          ...
                                          {dropdownItem.dropdownItems &&
                                            dropdownItem.dropdownItems.map(
                                              (innerItem) => (
                                                ...
                                                >
                                                  <div className="ml-12 flex items-center truncate">
                                ...
                                >
                                  <div className="flex ml-7 items-center truncate">
                                    <span className="truncate">
                                      {dropdownItem?.name}
                                    </span>
                                  </div>
                  ...
                  // rendered when only to show the title
                  <Title
                    as="h6"
                    className={cn(
