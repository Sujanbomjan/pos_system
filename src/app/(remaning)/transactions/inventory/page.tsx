...
import {
  formData,
  inventory,
} from "@/features/transactions/inventory/tableData";
...
const Page = () => {
  ...
  const {
    ...
    defaultValues: getDefaultValues(inventory[formStep]),
    resolver: yupResolver(schemaGenerator(inventory[formStep])),
  });
  ...
  const isFinalStepInvoice = formStep + 1 === inventory.length;
