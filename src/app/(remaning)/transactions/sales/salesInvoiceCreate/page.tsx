...
import { formData, salesCreate } from "@/features/transactions/sales/tableData";
...
const Page = () => {
  ...
  const {
    ...
    defaultValues: getDefaultValues(salesCreate[formStep]),
    resolver: yupResolver(schemaGenerator(salesCreate[formStep])),
  });
  ...
  const isFinalStepInvoice = formStep + 1 === salesCreate.length;
