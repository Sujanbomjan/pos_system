...
import { formData, selfBIll } from "@/features/transactions/sales/tableData";
...
const Page = () => {
  ...
  const {
    ...
    defaultValues: getDefaultValues(selfBIll[formStep]),
    resolver: yupResolver(schemaGenerator(selfBIll[formStep])),
  });
  ...
  const isFinalStepInvoice = formStep + 1 === selfBIll.length;
